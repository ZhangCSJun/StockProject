...
import admin.server.model.UpdateCompanyStatusRequest;
import admin.server.service.AdminService;
import common.constant.Constant;
import common.model.Response;
import common.model.StockPriceRowModel;
import common.util.ExcelHandler;
...
public class AdminController {
	...
	public ResponseEntity<Response> queryCompanyName() {
		Response response = adminService.queryCompanyByKeyWord("");
		return ResponseEntity.status(response.getStatus()).contentType(MediaType.APPLICATION_JSON).body(response);
	}
...
//	}
	...
	public ResponseEntity<Response> upload(@RequestParam("uploadFile") MultipartFile uploadFile) {
		...
		try {
			...
			List<StockPriceRowModel> stockPriceRowModelList = ExcelHandler
					.getStockPriceListFromExcel(uploadFile.getInputStream());
